...
class CocktailsListView extends StatefulHookConsumerWidget {
  const CocktailsListView({Key? key}) : super(key: key);

  @override
  _CocktailsListViewState createState() => _CocktailsListViewState();
}

class _CocktailsListViewState extends ConsumerState<CocktailsListView> {
  @override
  Widget build(BuildContext context) => PagedGridView<int, Cocktail>(
        pagingController: ref.watch(cocktailsViewModelProvider.notifier).getPagingController(),
